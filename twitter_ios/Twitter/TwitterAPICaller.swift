...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "o4xZ3TA8N0J4nlHPWaqdTdctW", consumerSecret: "mWswXLmW5IYJHEz0sgJZIIig4ZXYPkRex7FshBUKlywGtZOLb6")
    var loginSuccess: (() -> ())?
    ...
    //takes the tweet and actually should post it 
